...
export const CatalogContainer = ({productIdHit, productIdsStock}: CatalogContainerInterface) => {
  const productIds = useAppSelector((state: RootState) =>
    selectProductIds(state)
  );
  // console.log(productIds);
  return <CatalogItems productIds={productIds} productIdHit={productIdHit} productIdsStock={productIdsStock}/>;
};
